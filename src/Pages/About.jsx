        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Seorang Web Developer lulusan Teknik Informatika yang memiliki antusiasme tinggi dalam membangun website modern, responsif, dan fungsional. Saya terbiasa bekerja dengan HTML, CSS, JavaScript, PHP, Laravel, Bootstrap, dan SQL untuk menciptakan solusi web yang praktis dan user-friendly. Saya senang mempelajari teknologi baru, beradaptasi dengan cepat, dan selalu berusaha memberikan hasil kerja terbaik untuk setiap proyek yang saya tangani.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Building meaningful digital experiences, one line of code at a time."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1LKNYtpxeHvysclOZs-AJi43j9cxqAM1g/view?usp=drive_link" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
